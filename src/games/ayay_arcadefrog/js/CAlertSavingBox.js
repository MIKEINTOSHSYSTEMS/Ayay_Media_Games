function CAlertSavingBox(szText,oParentContainer){
    ...
    this._init = function (szText) {
        ...
        _oMsg = new CTLText(_oContainer, 
                    CANVAS_WIDTH/2-160, 210, 320, 150, 
                    16, "center", "#fff", FONT_GAME, 1.1,
                    0, 0,
                    szText,
                    true, true, true,
                    true );
        ...
        _oButOk = new CGfxButton(CANVAS_WIDTH / 2 + 140, 180, s_oSpriteLibrary.getSprite('but_exit_small'), _oContainer);

function CBall(iIndexColor,oContainer){
    ...
    this._init = function(iIndexColor,oContainer){
        ...
        _oSprite = createSprite(oSpriteSheet,null,BALL_RADIUS,BALL_RADIUS,BALL_DIAMETER, BALL_DIAMETER);
        _oSprite.stop();
    ...
    this.explode = function(){
        ...
        createjs.Tween.get(_oSprite).to({alpha:0} , 1000,createjs.Ease.cubicOut).call(function(){_oSprite.visible= false;});
        createjs.Tween.get(_oExplosion).to({alpha:0} , 1200,createjs.Ease.cubicOut).call(function(){oParent.onExplosionEnd()});
    };

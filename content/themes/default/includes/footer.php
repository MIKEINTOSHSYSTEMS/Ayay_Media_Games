		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 mb-5 mb-lg-0">
					<?php include TEMPLATE_PATH . '/parts/footer-widget-1.php' ?>
				</div>
				<div class="col-lg-4 mb-5 mb-lg-0">
					<?php include TEMPLATE_PATH . '/parts/footer-widget-2.php' ?>
				</div>
				<div class="col-lg-4">
					<?php include TEMPLATE_PATH . '/parts/footer-widget-3.php' ?>
				</div>
			</div>
		</div>
	</footer>
